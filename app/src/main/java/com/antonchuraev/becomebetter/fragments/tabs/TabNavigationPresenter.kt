...
enum class NavigationTab(@StringRes val textRes: Int, @StringRes val subTittleTextRes: Int , val relatedToGoalsType:Goal.ProgressType , @DrawableRes val backgroundRes:Int , @StringRes val createNewGoalText:Int , @StringRes val editTextHint:Int ,val editMaxLength:Int) {
    ...
    MOTIVATION(R.string.motivation , R.string.motivation_subtittle , Goal.ProgressType.DAYS , R.drawable.b1 , R.string.create_goal_motivation_text , R.string.motivation_hint , NavigationTab.MOTIVATION_MAX_INPUT_LENGTH),
    MONEY(R.string.money_box , R.string.money_box_subtittle , Goal.ProgressType.CUSTOM_MAX, R.drawable.b2 ,  R.string.create_goal_money_text , R.string.money_hint, NavigationTab.OTHER_MAX_INPUT_LENGTH),
    PROJECTS(R.string.projects , R.string.projects_subtittle , Goal.ProgressType.PERCENTS_AND_DAYS, R.drawable.b3 , R.string.create_goal_motivation_text , R.string.motivation_hint, NavigationTab.MOTIVATION_MAX_INPUT_LENGTH)
